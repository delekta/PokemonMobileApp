          ...
          <TouchableWithoutFeedback>
            <ScrollView>
              <View style={styles.container}>
                ...
                <View>
                  <Text style={styles.settingResult}>
                    Setting 1: {this.state.set1}
                  </Text>
                  <Text style={styles.settingResult}>
                    Setting 2: {this.state.set2}
                  </Text>
                  <Text style={styles.settingResult}>
                    Setting 3: {this.state.set3}
                  </Text>
                  <Text style={styles.settingResult}>
                    Setting 4: {this.state.set4}
                  </Text>
                </View>
                <View>
